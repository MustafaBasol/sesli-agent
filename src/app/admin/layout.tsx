...
const navGroups = [
  ...
  },
  {
    label: 'Operations',
    items: [
      { name: 'Reservations', href: '/admin/reservations', icon: 'reservations' },
      { name: 'Customers',    href: '/admin/customers',    icon: 'customers' },
      { name: 'Tables',       href: '/admin/tables',       icon: 'tables' },
  ...
  },
  {
    label: 'AI Activity',
    items: [
      { name: 'Calls',         href: '/admin/calls',         icon: 'calls' },
      { name: 'Changes',       href: '/admin/changes',       icon: 'changes' },
      { name: 'Cancellations', href: '/admin/cancellations', icon: 'cancellations' },
      { name: 'Staff Handoffs',href: '/admin/handoffs',      icon: 'handoffs' },
      { name: 'Tool Logs',     href: '/admin/tool-logs',     icon: 'logs' },
    ],
  },
  {
    label: 'System',
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-4 flex items-center justify-between" style={{ borderBottom: '1px solid var(--p-border)' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] mt-0.5 font-semibold" style={{ color: 'var(--p-text-5)' }}>AI Panel</p>
          </div>
        </div>
        <button
      ...
      <div className="p-3" style={{ borderTop: '1px solid var(--p-border)' }}>
        ...
        <div className="mb-2 px-3 py-2.5 rounded-lg flex items-center justify-between" style={{ background: 'var(--p-subtle)', border: '1px solid var(--p-border)' }}>
          <div>
            <p className="text-[10px] font-bold" style={{ color: 'var(--p-text-4)' }}>Admin</p>
            <div className="flex items-center gap-1.5 mt-0.5">
              <span className="w-1.5 h-1.5 rounded-full bg-green-400 status-online shrink-0" />
              <p className="text-[9px] text-green-500 font-semibold uppercase tracking-wider">Online</p>
            </div>
          </div>
          <button
            onClick={toggleTheme}
      ...
      <main className="flex-1 overflow-y-auto min-w-0">
        ...
        <div className="md:hidden sticky top-0 z-30 flex items-center gap-3 px-4 py-3 backdrop-blur" style={{ background: 'color-mix(in srgb, var(--p-bg) 97%, transparent)', borderBottom: '1px solid var(--p-border)' }}>
          ...
          <div className="ml-auto flex items-center gap-2">
            <span className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: 'var(--p-text-5)' }}>AI Panel</span>
            <button
              onClick={toggleTheme}
