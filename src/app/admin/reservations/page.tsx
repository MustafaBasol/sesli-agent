            ...
            <tbody>
              {loading ? (
                ...
                <tr key={res.id}>
                  ...
                  <td className="text-sm font-medium" style={{ color: 'var(--p-text-3)' }}>{res.party_size} guests</td>
                  <td>
                    {res.tables ? (
                      <span className="badge badge-amber">Table {res.tables.table_number}</span>
                    ) : (
          ...
          {loading ? (
            ...
            <div key={res.id} className="p-4 space-y-3" style={{ borderBottom: '1px solid var(--p-border-2)' }}>
              <div className="flex justify-between items-start">
                ...
                <span className={`badge ${res.status === 'confirmed' ? 'badge-green' : 'badge-amber'}`}>{res.status}</span>
              </div>
              <div className="flex gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold" style={{ color: 'var(--p-text-2)' }}>{res.party_size} guests</p>
                </div>
              </div>
              {res.tables && <span className="badge badge-amber">Table {res.tables.table_number}</span>}
