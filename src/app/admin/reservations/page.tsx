    ...
    <div>
      <header className="mb-8 flex justify-between items-center">
        ...
        <button 
          ...
          className="bg-orange-600 hover:bg-orange-500 text-white px-6 py-2 rounded-xl text-sm font-black transition-all"
        >
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end gap-2 transition-all">
                    <button 
                      ...
                      className="text-xs bg-gray-800 px-3 py-1.5 rounded-lg border border-gray-700 hover:text-orange-500"
                    >
                      Edit
                    </button>
                    <button 
